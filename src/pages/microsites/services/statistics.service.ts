...
export class StatisticsService {
  ...
  public static async countTodayApposByProfessional(id: string): Promise<IResponse<IStats>> {
    const path: string = `${this.API_URL}/statistics/countTodayApposByProfessional`;
