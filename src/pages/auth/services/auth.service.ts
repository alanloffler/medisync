...
export class AuthService {
  public static async login({ email, password }: ILogin): Promise<AxiosResponse<IResponse<IPayloadPlus>>> {
  ...
  public static async getAdmin(): Promise<AxiosResponse<IResponse<IPayloadPlus>>> {
    const response = await api({
      method: 'GET',
      url: '/auth/admin',
      withCredentials: true,
