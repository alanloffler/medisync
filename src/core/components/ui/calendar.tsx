  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button_previous: 'absolute right-10 border-none !bg-input hover:!bg-input-hover !opacity-100',
        nav_button_next: 'absolute right-0 border-none !bg-input hover:!bg-input-hover !opacity-100',
